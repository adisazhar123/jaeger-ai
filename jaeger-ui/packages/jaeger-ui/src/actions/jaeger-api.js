...
import JaegerAPI, { GenAIJaegerAPI } from '../api/jaeger';
...
export const searchTraceByQuery = createAction(
  '@JAEGER_API/SEARCH_TRACE_BY_QUERY',
  query => GenAIJaegerAPI.searchTrace(query),
  query => ({ query })
);
