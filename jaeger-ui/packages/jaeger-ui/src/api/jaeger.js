...
export const GENAI_JAEGER_API_ROOT = 'http://localhost:54320/api'
...
export const GenAIJaegerAPI = {
  apiRoot: GENAI_JAEGER_API_ROOT,
  searchTrace(query) {
    // todo: do not hardcode
    const limit = 5;
    return getJSON(`${this.apiRoot}/search`, { query: {query, limit} })
  }
};
