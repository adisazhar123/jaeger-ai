...
export function submitForm(fields, searchTraces, genAIMode = false) {
  console.log('in submitForm', fields)

  if (genAIMode) {
    searchTraces(fields.query);
  } else {
    const {
      resultsLimit,
      service,
...
export class SearchFormImpl extends React.PureComponent {
  render() {
    ...
    console.log('searchTraceByQuery', searchTraceByQuery)
...
SearchFormImpl.propTypes = {
  ...
  searchTraceByQuery: PropTypes.func,
...
export function mapDispatchToProps(dispatch) {
  const { searchTraces, searchTraceByQuery } = bindActionCreators(jaegerApiActions, dispatch);
  return {
