...
export class TracePageImpl extends React.PureComponent<TProps, TState> {
  ...
  render() {
    ...
    const a = Array(10).fill('')
      .map(_ => (<Text>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consectetur eaque et in nihil porro possimus, quis reiciendis rem similique veniam. </Text>))
